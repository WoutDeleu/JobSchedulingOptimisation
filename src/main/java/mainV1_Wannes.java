...
//    //TODO opsplitsen in planSetup en planJobInitialSolution, op een manier zorgen dat ze altijd samen worden uitgevoerd
...
//            if (setup.checkExecutable(unavailablePeriods)) {
